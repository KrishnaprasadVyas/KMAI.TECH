            ...
            return (
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
                  ...
                  >
                    <div className="relative aspect-[16/10] sm:aspect-[16/9] w-full overflow-hidden bg-[#E5E2D8]">
                      <img
                        src={project.image}
                        alt={project.title}
                  ...
                  >
                    <div>
                      <span className="font-body text-xs sm:text-sm text-[#73777F] tracking-normal block mb-2">
                        {project.category}
                      </span>
                      <h3
                        className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-[#0A0C0F] tracking-tight cursor-pointer hover:text-[#216BFF] transition-colors"
                        onClick={() => setSelectedCaseStudy(project)}
                      >
                        {project.title}
                      </h3>
                    ...
                    <p className="font-body text-base sm:text-lg text-[#595D65] font-normal leading-relaxed">
                      {project.description}
                    </p>
                    ...
                    <div className="flex flex-wrap items-center gap-6 pt-2">
                      <button
                        ...
                        className="inline-flex items-center gap-2 text-[#0A0C0F] hover:text-[#216BFF] font-body text-sm font-medium transition-colors"
                      >
                      ...
                      {project.url && (
                        <a
                          ...
                          onMouseEnter={() => onCursorChange?.('button')}
                          onMouseLeave={() => onCursorChange?.('default')}
                          className="inline-flex items-center gap-2 text-[#73777F] hover:text-[#0A0C0F] font-body text-sm font-normal transition-colors"
                        >
                          <span>Live site</span>
